...
WEBHOOK_URL = os.getenv("WEBHOOK_URL") # Yeh aapke server ya ngrok ka URL hoga
GROQ_API_URL = "https://api.groq.com/openai/v1/chat/completions"

BOT_USERNAME = "Varsha" # Bot ka naam
...
# ========================================================================================
# Har user ki conversation history yaad rakhega
conversation_memory = {}
# Har chat ki personality setting yaad rakhega
chat_personalities = {}

# ========================================================================================
# === 5. PERSONALITY PROMPTS (HINGLISH MEIN) ==============================================
# ========================================================================================
...
def get_ai_response(user_id, chat_id, user_message):
    ...
    # Is chat ke liye current personality kya hai?
    ...
    # User ki purani conversation history nikalna
    history = conversation_memory.get(user_id, [])
    history.append({"role": "user", "content": user_message})
    
    # Memory limit maintain karna
    ...
    try:
        ...
        # Nayi baaton ko memory mein save karna
    ...
    try:
        ...
        if 'callback_query' in data:
            ...
            if callback_data == 'show_help':
                send_telegram_message(chat_id, get_help_text())
                # Button ke loading icon ko hatane ke liye
