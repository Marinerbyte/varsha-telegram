...
# ========================================================================================
# === 7. COMMAND & AI LOGIC (REWRITTEN & FIXED) ==========================================
# ========================================================================================
...
def get_ai_response(user_id, chat_id, user_message):
    """AI se jawab generate karwata hai (FIXED LOGIC)"""
    ...
    # 1. Purani history nikaalo
    old_history = conversation_memory.get(user_id, [])

    # 2. AI ko bhejne ke liye messages tayyar karo
    messages_to_send = [
    ...
    try:
        ...
        # Agar error ho, toh server ka jawab bhi print karo
        ...
        # 3. Memory save karne ke liye nayi history banao
        new_history = old_history + [
            {"role": "user", "content": user_message},
            {"role": "assistant", "content": ai_reply}
        ]

        # 4. Memory limit check karo
