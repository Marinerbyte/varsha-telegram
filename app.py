...
import os
import requests
import json  # Yeh import zaroori hai debugging ke liye
import logging
...
def get_ai_response(user_id, chat_id, user_message):
    ...
    try:
        # === DEBUGGING LINE: Yeh line Groq ko bheji jane wali request ko logs mein print karegi ===
        logging.info(f"GROQ PAYLOAD: {json.dumps(payload, indent=2)}")
